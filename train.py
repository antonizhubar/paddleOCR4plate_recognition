...
# yapf: disable
add_arg('num_classes',       int,   65,      "Number of classes.")
add_arg('batch_size',        int,   64,         "Minibatch size.")
add_arg('total_step',        int,   1000,    "The number of iterations. Zero or less means whole training set. More than 0 means the training set might be looped until # of iterations is reached.")
